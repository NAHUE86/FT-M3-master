...
function problemB () {
  ...
  // la constante (PROMISES) tiene adentro un array de nombres de archivos(FILESNAME).
  // x cada nombre de archivo(FILE) devuelve una promesa de que va a leer el archivo(PROMISIFIEDREADFILE) y luego lo va mostrar(THEN)
